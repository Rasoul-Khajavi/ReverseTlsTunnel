...
--connection-age:4800 --parallel-cons:18
...
**
اگه روی نسخه بالاتر از 5.4 اختلال و قطعی های زمانی احساس میکنید این سوییچ در دستور خارج و داخل اضافه کنید و همزمان تانل رو اجرا کنید 

> --connection-age:4800

این پروژه دیگه آپدیت نمیشه ؛ الان همین روش و چند تا روش دیگه اومده روی waterwall و من پارت تایم روی اون کار خواهم کرد.

همچنین کلا در روش های تونل معکوس تغییر sni رو تست کنید ؛ کم کم دارن به سمت محدود کردن sni ها رو میارن.
